...
// Exact SVG rank glyphs supplied by the user.
// No font rendering or getBBox measurement: each number keeps its own original viewBox/path.
function RankNumber({ n }) {
  const rank = TOP10_RANKS[n];
  if (!rank) return null;
