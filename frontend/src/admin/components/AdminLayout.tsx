    ...
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column', bgcolor: '#0d0d0d' }}>
      ...
      <List sx={{ px: 2, py: 2 }}>
        <ListItem disablePadding>
          <ListItemButton onClick={() => navigate('/browse')} data-testid="nav-back-to-site" sx={{ borderRadius: 2, py: 1.5, '&:hover': { bgcolor: 'rgba(255,255,255,0.04)' } }}>
            <ListItemIcon sx={{ color: 'grey.500', minWidth: 44 }}><HomeIcon /></ListItemIcon>
            <ListItemText primary="Torna al Sito" primaryTypographyProps={{ fontSize: 14, color: 'grey.400' }} />
          </ListItemButton>
        </ListItem>
      </List>
    </Box>
